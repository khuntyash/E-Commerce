...
const features = [
  ...
  {
    title: "Return Fraud Protection",
    desc: "Stop scammers before you ship. We cross-reference millions of data points to flag buyers with suspicious return histories.",
