  ...
  const testimonials = [
    {
      ...
      content: "Zero's label cropper alone saves me 3 hours every day. The suspicious order detection caught 47 bad orders in my first week. My returns dropped 38%."
    },
    {
      name: "Priya S.",
